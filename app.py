...
with open('scaler.pkl','rb') as file: # Corrected file opening mode
...
input_data_dict = {
    ...
    'Geography': geography  # Include the raw geography for one-hot encoding
}
...
input_data = pd.concat([input_df, geo_encoder_df], axis=1)
